OC.L10N.register(
    "secrets",
    {
    "A <strong>Secret</strong> was created" : "A <strong>Secret</strong> was created",
    "A <strong>Secret</strong> has expired without being retrieved" : "A <strong>Secret</strong> has expired without being retrieved",
    "Secrets" : "Secrets",
    ...
    "A <strong>Secret</strong> was retrieved" : "A <strong>Secret</strong> was retrieved",
    ...
    "If you set an access password, anyone opening the share link will also need to enter this password before they can view the secret." : "If you set an access password, anyone opening the share link will also need to enter this password before they can view the secret.",
    "Secret content" : "Secret content",
    "Type or paste the secret you want to share (e.g. a password, CSV data, or bank account details)…" : "Type or paste the secret you want to share (e.g. a password, CSV data, or bank account details)…",
    "Save" : "Save",
    "No secret selected" : "No secret selected",
    "never" : "never",
    "has access password" : "has access password",
    "no access password" : "no access password",
    "Share Link:" : "Share Link:",
    "This secret has expired and its content was consequently deleted from the server." : "This secret has expired and its content was consequently deleted from the server.",
    ...
    "Can't save already existing secret" : "Can't save already existing secret",
    "Secret from {date} {time}" : "Secret from {date} {time}",
    ...
    "Your secret is stored end-to-end encrypted on the server. It can only be decrypted by someone who has been given the link. Once retrieved successfully, the secret will be deleted on the server" : "Your secret is stored end-to-end encrypted on the server. It can only be decrypted by someone who has been given the link. Once retrieved successfully, the secret will be deleted on the server",
    "Create a secret to get started" : "Create a secret to get started",
    "Secrets is only available when visiting Nextcloud at an encrypted (https) address." : "Secrets is only available when visiting Nextcloud at an encrypted (https) address.",
    "Could not decrypt secret" : "Could not decrypt secret",
    "Are you sure you want to leave the page? You will not be able to retrieve the secret again." : "Are you sure you want to leave the page? You will not be able to retrieve the secret again.",
    "The following secret has been shared with you securely:" : "The following secret has been shared with you securely:",
    "Please make sure you have copied and stored the secret before closing this page! It is now deleted on the server." : "Please make sure you have copied and stored the secret before closing this page! It is now deleted on the server.",
    "Copy to Clipboard" : "Copy to Clipboard",
    "Copy the secret to the clipboard" : "Copy the secret to the clipboard",
    "Download" : "Download",
    "Download the secret as a file" : "Download the secret as a file",
    ...
    "Copy Secret Link" : "Copy Secret Link",
    "share password (optional)" : "share password (optional)",
    "Copy the secret's content to the clipboard" : "Copy the secret's content to the clipboard",
    "Download the secret's content as a file" : "Download the secret's content as a file",
    "Retrieving secret..." : "Retrieving secret..."
},
