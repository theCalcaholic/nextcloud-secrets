OC.L10N.register(
    ...
    {
    "Secrets" : "Tajemství",
    "Secret '{secret}' has been retrieved" : "Tajemství „{secret}“ bylo obdrženo",
    ...
    "Expires on:" : "Platné do:",
    "password protected" : "chráněno heslem",
    "Share Link:" : "Odkaz na sdílení:",
    "Copy Secret Link" : "Zkopírovat tajný odkaz",
    ...
    "share password (optional)" : "heslo do sdílení (volitelné)",
    "Save" : "Uložit",
    "The following secret has been shared with you securely:" : "Bylo vám zabezpečeně nasdíleno následující tajemství:",
    "Please make sure you have copied and stored the secret before closing this page! It is now deleted on the server." : "Než tuto stránku zavřete, ujistěte se, že jste si tajemství zkopírovali a hlavně uložili! Na serveru totiž bude vymazáno.",
    "Copy the secret's content to the clipboard" : "Zkopírovat obsah tajemství do schránky",
    ...
    "Reveal Secret" : "Odkrýt tajemství",
    "Revealing will delete the secret from the server" : "Odkrytí tajemství vymaže ze serveru",
