OC.L10N.register(
    ...
    "Secret from {date} {time}" : "Парольна фраза від {date}{time}",
    ...
    "Expires on:" : "Термін дії:",
    "password protected" : "захищено паролем",
    "Share Link:" : "Поділитися посиланням:",
    "Copy Secret Link" : "Копіювати посилання на секретне повідомлення",
    "This secret has already been retrieved and its content was consequently deleted from the server." : "Це секретне повідомлення вже було отримано, а його вміст вилучено із сервера.",
    "Could not decrypt secret (key not available locally)." : "Не вдалося розшифрувати секретне повідомлення (ключ недоступний на пристрої).",
    ...
    "share password (optional)" : "поділитися паролем (необов'язково)",
    "Save" : "Зберегти",
    "Could not decrypt secret" : "Не вдалося розшифрувати секретне повідомлення",
    "The following secret has been shared with you securely:" : "З вами поділилися таким секретним повідомленням:",
    "Please make sure you have copied and stored the secret before closing this page! It is now deleted on the server." : "Перевірте, що ви скопіювали та зберегли секретне повідомлення перед тим, як закриєте сторінку! Після цього його буде знищено.",
    "Copy the secret's content to the clipboard" : "Копіювати вміст секретного повідомлення до буферу обміну",
    ...
    "I understand. Reveal and destroy Secret." : "Я розумію. Розкрити та знищити секретне повідомлення.",
