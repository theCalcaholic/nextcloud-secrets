OC.L10N.register(
    ...
    "Download the secret as a file" : "Télécharger le secret en tant que fichier",
    "This secret has expired and its content was consequently deleted from the server." : "Ce secret a expiré et son contenu a donc été supprimé du serveur.",
    "This secret has already been retrieved and its content was consequently deleted from the server." : "Ce secret a déjà été récupéré et son contenu a par conséquent été supprimé du serveur.",
    ...
    "Can't save already existing secret" : "Impossible d'enregistrer un secret existant",
    "Secret from {date} {time}" : "Secret du {date} {time}",
    ...
    "Your secret is stored end-to-end encrypted on the server. It can only be decrypted by someone who has been given the link. Once retrieved successfully, the secret will be deleted on the server" : "Votre mot de passe est stocké sur le serveur avec un chiffrement de bout en bout. Seule la personne à qui le lien a été transmis peut le déchiffrer. Une fois récupéré, le mot de passe sera supprimé du serveur.",
    ...
    "Copy Secret Link" : "Copier le lien du secret",
    "share password (optional)" : "Mot de passe du partage (facultatif)",
    "Copy the secret's content to the clipboard" : "Copier le contenu du secret dans le presse-papier",
    "Download the secret's content as a file" : "Télécharger le contenu du secret en tant que fichier",
    "Retrieving secret..." : "Récupération du secret..."
},
