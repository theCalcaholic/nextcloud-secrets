OC.L10N.register(
    ...
    "Download" : "تنزيل",
    "Retrieving secret…" : "إسترجاع السر ...",
    "Error loading secret. Is your link correct?" : "خطأ في تحميل السر. هل الرابط الخاص بك صحيح؟",
    "Revealing will delete the secret from the server. You will not be able to retrieve it again." : "سيؤدي الكشف إلى حذف السر من الخادم، و لن تتمكن من استعادته مرة أخرى.",
