OC.L10N.register(
    ...
    "Create a secret to get started" : "Erstellen Sie ein Passworts, um loszulegen",
    "Could not fetch secrets" : "Abruf der Passwörter fehlgeschlagen",
    "New Secret" : "Neues Geheimnis",
    "Could not create the secret" : "Erstellung des Passworts fehlgeschlagen",
    "Secret deleted" : "Geheimnis gelöscht",
    "Could not delete the secret" : "Löschen des Passworts fehlgeschlagen",
    ...
    "Save" : "Speichern",
    "The following secret has been shared with you securely:" : "Das folgende Geheimnis wurde Ihnen auf sichere Weise mitgeteilt:",
    "Please make sure you have copied and stored the secret before closing this page! It is now deleted on the server." : "Bitte stellen Sie sicher, dass Sie das Geheimnis kopiert und gespeichert haben, bevor Sie diese Seite schließen! Sie ist nun auf dem Server gelöscht.",
    ...
    "Reveal Secret" : "Geheimnis aufdecken",
    "Revealing will delete the secret from the server" : "Durch das Aufdecken wird das Geheimnis vom Server gelöscht.",
