OC.L10N.register(
    "secrets",
    {
    "A <strong>Secret</strong> was created" : "已建立<strong>祕密</strong>",
    "A <strong>Secret</strong> has expired without being retrieved" : "<strong>祕密</strong>未擷取即過期",
    "Secrets" : "祕密",
    "Secret '{secret}' has been retrieved" : "已擷取祕密「{secret}」",
    "Secret '{secret}' has expired without being retrieved" : "祕密「{secret}」已過期但未被擷取",
    "A <strong>Secret</strong> was retrieved" : "已擷取<strong>祕密</strong>",
    ...
    "Expires on:" : "過期於：",
    "Expiration Date" : "到期日",
    "access password (optional)" : "存取密碼（選擇性）",
    "If you set an access password, anyone opening the share link will also need to enter this password before they can view the secret." : "如果您設定了存取密碼，任何開啟共享連結的人在查看該祕密之前，也必須先輸入此密碼。",
    "Secret content" : "祕密內容",
    "Type or paste the secret you want to share (e.g. a password, CSV data, or bank account details)…" : "請輸入或貼上您要分享的機密資訊（例如：密碼、CSV 資料或銀行帳號詳細資訊）⋯⋯",
    "Save" : "儲存",
    "No secret selected" : "未選取祕密",
    "never" : "永不",
    "has access password" : "有存取密碼",
    "no access password" : "沒有存取密碼",
    "Share Link:" : "分享連結：",
    "This secret has expired and its content was consequently deleted from the server." : "此秘密已過期，其內容已從伺服器中刪除。",
    ...
    "Can't save already existing secret" : "無法儲存既有的祕密",
    "Secret from {date} {time}" : "來自 {date} {time} 的祕密",
    ...
    "Delete secret" : "刪除祕密",
    "Your secret is stored end-to-end encrypted on the server. It can only be decrypted by someone who has been given the link. Once retrieved successfully, the secret will be deleted on the server" : "您的祕密會以端對端加密的方式儲存於伺服器上。只有取得連結的人才能解密該祕密。一旦成功擷取，該祕密將從伺服器上刪除",
    "Create a secret to get started" : "建立祕密以開始使用",
    "Secrets is only available when visiting Nextcloud at an encrypted (https) address." : "「祕密」功能僅在透過加密 (https) 網址存取 Nextcloud 時才可用。",
    "Could not decrypt secret" : "無法解密祕密",
    "Are you sure you want to leave the page? You will not be able to retrieve the secret again." : "您確定要離開此頁面嗎？您將無法再次擷取此祕密。",
    ...
    "Copy the secret to the clipboard" : "將祕密複製到剪貼簿",
    "Download" : "下載",
    "Download the secret as a file" : "將祕密下載為檔案",
